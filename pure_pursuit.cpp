#include <iostream>
#include "pure_pursuit_controller.cpp"
...
string filePath     = "/home/basaran/Masaüstü/PurePursuit/points.txt";
...
vector<vector<double>> loadPointsFromFile() {
  ...
  if (isPathExists(filePath))
    cout << "Saved points file exists!" << endl;
  else {
    cout << "Saved points file does not exists!" << endl;
...
vector<double> goalPose{18, 20};   // Goal Pose
